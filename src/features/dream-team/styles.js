export const w = {
  ...
  panelStaleBadge: 'font-mono text-[10px] text-stale bg-stale/10 border border-stale/20 px-2 py-0.5 rounded-full shrink-0',
  ...
  // Games warning inside Dream panel
  ...
  teamList:        'flex flex-col gap-1.5 max-h-[400px] overflow-y-auto',
  teamRow:         'flex items-center justify-between gap-2 bg-surface-raised border border-border rounded-[6px] px-3 py-2.5 transition-colors',
  teamRowSelected: 'border-primary/50 bg-primary/5',
  teamLeft:        'flex items-center gap-2 min-w-0',
  ...
  // Selected team list (right panel)
  selectedList:    'flex flex-col gap-1.5 max-h-[400px] overflow-y-auto',
  selectedRow:     'flex items-center justify-between gap-2 bg-surface-raised border border-border rounded-[6px] px-3 py-2.5',
  selectedLeft:    'flex items-center gap-2 min-w-0',
  selectedRight:   'flex items-center gap-2 shrink-0',
  goalsBadge:      'font-mono text-[13px] font-semibold text-gold',
  goalsUnit:       'text-[10px] text-ink-dim font-normal',
  pendingBadge:    'font-mono text-[10px] text-stale bg-stale/10 border border-stale/20 px-2 py-0.5 rounded-full',
  ...
  footerStaleBadge:'font-mono text-[10px] text-stale bg-stale/10 border border-stale/20 px-2.5 py-0.5 rounded-full',
